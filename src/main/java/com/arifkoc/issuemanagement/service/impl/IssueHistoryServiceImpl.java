...
public class IssueHistoryServiceImpl implements IssueHistoryService {
    ...
    public List<IssueHistoryDto> getByIssueId(Long id) {
        List<IssueHistory> issueHistoryDtos=issueHistoryRepository.getByIssueIdOrderById(id);

        return Arrays.asList(modelMapper.map(issueHistoryDtos, IssueHistoryDto[].class));
    }
